<template>
  <div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md border border-[#D1D9E6] bg-white rounded-lg p-8">
      ...
      <div class="space-y-4">
        <button
          class="w-full flex items-center justify-center gap-2 rounded-[6px] border border-gray-300 bg-[#F6F8FA] text-[#111111] py-2.5 text-sm font-medium transition-colors hover:bg-[#eff2f5] cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
