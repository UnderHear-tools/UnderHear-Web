...
<template>
  <component
    :is="href ? 'a' : 'button'"
    class="z-blankslate-primary-action"
...
.z-blankslate-primary-action {
  ...
  margin-top: var(--z-blankslate-action-margin-top, 0.5rem);
...
.z-blankslate-primary-action:hover:not(:disabled):not([aria-disabled='true']) {
  background-color: var(--button-primary-bgColor-hover, #1c8139);
}

.z-blankslate-primary-action:active:not(:disabled):not([aria-disabled='true']) {
  background-color: var(--button-primary-bgColor-active, #197935);
}

.z-blankslate-primary-action:focus-visible {
  box-shadow: inset 0 0 0 3px var(--fgColor-onEmphasis, #ffffff);
  outline: 2px solid var(--focus-outlineColor, #0969da);
  outline-offset: 2px;
}

.z-blankslate-primary-action:disabled,
.z-blankslate-primary-action[aria-disabled='true'] {
