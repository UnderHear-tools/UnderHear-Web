...
import com.onlikee.module.auth.oauth.service.AuthGiteeService;
...
public class AuthGiteeServiceImpl implements AuthGiteeService {
    ...
    public OAuthCallbackWithTokenDTO login(AuthResponse<AuthUser> authResponse) {
        ...
        // 转成更新后的User对象
        user = com.onlikee.module.user.converter.ToEntity.toUpdateUserEntity(user, LocalDateTime.now(), "GITEE_OAUTH");
        // 生成token
