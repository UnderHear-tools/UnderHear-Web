...
import com.onlikee.auth.oauth.service.AuthGithubService;
...
public class AuthGithubServiceImpl implements AuthGithubService {
    ...
    public OAuthCallbackWithTokenDTO login(AuthResponse<AuthUser> authResponse) {
        ...
        //转成更新后的User对象
        user = com.onlikee.user.converter.ToEntity.toUpdateUserEntity(user,LocalDateTime.now(),"GITHUB_OAUTH");
        //生成token
