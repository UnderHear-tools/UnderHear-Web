...
// 引入数据
import projectData from '../onlikee/data/Projectcard.json'
...
.tip-section {
    border-left: 3.5px solid var(--borderColor-success-emphasis);
    padding: 0.5rem 1rem;
    margin-bottom: 20px;
}

.tip-section1 {
    border-left: 3.5px solid var(--borderColor-default);
    padding: 0rem 1rem;
    margin: 16px 0px;
}
